...
from trainer.models.wan21.wan.modules.attention import ulysses
from trainer.models.wan21.wan.modules.model import rope_apply_sp
...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        if self.enable_sp:
            ...
            e = dist_ops.split_forward_gather_backward(e, dim=1, group=sp_group, grad_scale="down")
            e0 = dist_ops.split_forward_gather_backward(e0, dim=1, group=sp_group, grad_scale="down")
