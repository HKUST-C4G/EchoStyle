...
class WanFLF2V:
    ...
    def generate(
        ...
        if first_frame_size != last_frame_size:
            ...
            # 2. center crop
            ###############################################
            # Modified by wan_trainer to fix center crop. #
            ###############################################
            transform = transforms.Compose(
                [
                    transforms.Resize((last_frame_size[1], last_frame_size[0])),
                    transforms.CenterCrop((first_frame_size[1], first_frame_size[0])),
                ]
            )
        ...
        #############################################################
        # Modified by wan_trainer to fix hard-coded length of mask. #
        #############################################################
